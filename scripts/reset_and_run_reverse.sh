...
echo "🔄 PC2: foundValueをクリアして下から再実行します"
echo ""
...
npx tsx scripts/fill_null_fields_from_csv_enhanced.ts 2>&1 | tee fill_null_fields_reverse.log
